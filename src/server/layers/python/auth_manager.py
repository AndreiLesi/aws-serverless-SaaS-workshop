            ...
            "Statement": [
                {
                    ...
                    "Resource": [
                        "arn:aws:dynamodb:{0}:{1}:table/TenantUserMapping".format(region, aws_account_id),
                        "arn:aws:dynamodb:{0}:{1}:table/TenantDetails".format(region, aws_account_id)
                    ],
                    "Condition": {
                ...
                },
                {
                    ...
                    "Resource": [
                        "arn:aws:dynamodb:{0}:{1}:table/TenantStackMapping".format(region, aws_account_id),
                        "arn:aws:dynamodb:{0}:{1}:table/Settings".format(region, aws_account_id)
                    ]
                }
            ]
        }
